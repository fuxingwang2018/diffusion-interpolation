...
export OUT_DIR=/home/users/u101329/p200177_t1_hp/u101329/results/samples_utv_2024 #
...
python generate/sample.py --config-path `pwd`/conf -cn ddp_config_generate.yaml \
    ckpt_file='/home/users/u101329/p200177_t2/u101329/diffusion-interp/_work/ddpm-npy-uvt-20250929_203652/epoch-419-val_loss-0.002.ckpt' \
    outdir=${OUT_DIR} \
